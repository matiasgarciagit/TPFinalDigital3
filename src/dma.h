...
#include "F:\Users\Matias Garcia\Documents\MCUXpressoIDE_11.4.0_6237\workspace\CMSISv2p00_LPC17xx\Drivers\inc\lpc17xx_clkpwr.h"
#include "F:\Users\Matias Garcia\Documents\MCUXpressoIDE_11.4.0_6237\workspace\CMSISv2p00_LPC17xx\Drivers\inc\lpc17xx_exti.h"
#include "F:\Users\Matias Garcia\Documents\MCUXpressoIDE_11.4.0_6237\workspace\CMSISv2p00_LPC17xx\Drivers\inc\lpc17xx_gpdma.h"
...
int main(void)
{
    ...
    8660,9135,9510,9781,9945,10000\
        ...
        GPDMACfg.SrcMemAddr = (uint32_t)dato;	//Origen
        ...
        GPDMACfg.TransferType = GPDMA_TRANSFERTYPE_P2M;	//Tipo de transferencia = Memory 2 Peripheral
        GPDMACfg.SrcConn = 0;	//La fuente es memoria => no connection
        GPDMACfg.DstConn = GPDMA_CONN_ADC;	//Destino : conexión al ADC
